...
"""Evaluate a Cosmos3 UR5 joint-pos policy with keypoint-IK camera geometry."""
...
POLICY = "cosmos3_ur5_keypoint_ik_jointpos"
...
from policies.cosmos3.keypoint_ik_client import Cosmos3UR5KeypointIKJointposClient  # noqa: E402
...
def make_client(args: argparse.Namespace) -> Cosmos3UR5KeypointIKJointposClient:
    return Cosmos3UR5KeypointIKJointposClient(
